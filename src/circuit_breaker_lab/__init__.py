...
def main() -> None:
    ...
    parser.add_argument(
        "--host", dest="host", type=str, default="0.0.0.0", help="Host IP to listen on"
    )
    ...
    app.run(
        host=args.host, port=args.flask_port, debug=args.flask_debug, use_reloader=False
    )
